...
const SERVICES = [
  ...
  },
  {
    ...
    desc: `A fence is only as good as its gate. We design, fabricate, and install every type of gate — from a simple wood swing gate to a fully automated driveway system. Every gate is custom-built to match your fence, your property layout, and your access needs.\n\nWe work with wood, steel, aluminum, and vinyl. Whether you need a manual cantilever, a motorized slide gate, or a decorative iron entry, we'll build it right.`,
    bullets: [
      "Automated & motorized gate operators",
      "Cantilever sliding gates",
      "Fabricated steel & iron gates",
      "Custom wood swing & slide gates",
      "Aluminum & vinyl gate systems",
      "Single & double driveway configurations",
      "Access control & keypad integration",
    ],
    badge: "Custom Built",
    image:
      "https://images.pexels.com/photos/48246/pexels-photo-48246.jpeg?auto=compress&cs=tinysrgb&w=900",
  },
  {
    slug: "commercial",
